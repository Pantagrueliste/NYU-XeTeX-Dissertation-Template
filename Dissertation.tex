...
\setdefaultlanguage[variant=american]{english} %change this line to select a different default language
...
\usepackage[series={},nocritical,noend,noeledsec,nofamiliar,noledgroup]{reledmac} %useful for criticasl editions
